...
export class DialogEditTableItemComponent implements OnInit {
  ...
  this.configureEntity.updateEntityConfigure(this.idDbRegistered,this.entityConfigure).subscribe(ok => 
    this.toast.success(`Update `+this.data.name+` successfully!`,`Easy Web: Information`)
    );
  }
